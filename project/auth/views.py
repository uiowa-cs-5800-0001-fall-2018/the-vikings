...
# curl --header "Content-Type: application/json" --request POST --data '{"username":"xyz","password":"xyz","email":"ehhe"}' http://104.248.121.89:5000/auth/register
...
# curl --header "Authorization: Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE1NDM2MzQ2MTIsImlhdCI6MTU0MTA0MjYxMiwic3ViIjoyfQ.Jo2gim_ujR8i1sC7Ys2Htw6BKq9aUKMZarRzZdQ7O7w" --request POST  http://104.248.121.89:5000/auth/logout
auth_blueprint.add_url_rule(
    '/auth/logout',
